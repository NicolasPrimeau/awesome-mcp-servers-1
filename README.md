...
- [Artel](https://github.com/NicolasPrimeau/artel) - Self-hosted coordination layer for AI agent fleets — shared semantic memory, tasks, agent-to-agent messages, and session handoffs over MCP and REST. Any HTTP client participates.
